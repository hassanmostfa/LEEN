...
class ResetPasswordController extends Controller
{
    ...
    /**
     * Send OTP to the customer's phone for password reset (store in cache only)
     */
    public function resetPasswordOtp(Request $request)
    {
        ...
        if (!$customer) {
            return $this->errorResponse('Customer with phone ' . $phone . ' not found', 404);
        }
        ...
        Log::info("Sending password reset OTP to customer {$phone} with code {$verificationCode}");
    ...
    /**
     * Verify the OTP sent to the customer's phone (using cache only)
     */
    ...
    /**
     * Reset the customer's password after OTP verification (using cache verification)
     */
    ...
    {
        return "customer_password_reset_otp:{$phone}";
    }
    ...
    {
        return "customer_password_reset_verified:{$phone}";
    }
