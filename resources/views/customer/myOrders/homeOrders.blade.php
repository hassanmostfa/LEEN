                        ...
                        <tbody>
                            @foreach ($homeBookings as $homeBooking)
                                <tr>
                                    ...
                                    <td>
                                        {{ $homeBooking->homeService->name }} <!-- Main Service Name -->
                                    ...
                                    <td>{{ $homeBooking->seller->first_name }} {{ $homeBooking->seller->last_name }}</td>
                                    ...
                                    <td>
                                        ...
                                        @elseif($homeBooking->booking_status == 'done')
                                            <span class="badge bg-success">مكتمل</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if ($homeBooking->booking_status == 'rejected')
                                        <a href="{{ route('customer.bookHomeService.edit', $homeBooking->id) }}" class="btn btn-sm btn-outline-danger mx-2 border-2" style="font-weight: 600 !important;">السبب</a>
                                        @elseif($homeBooking->booking_status == 'done')
                                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#ratingModal">
                                            تقييم الخدمة
                                        </button>
                                        @else
                                        <a href="{{ route('customer.bookHomeService.edit', $homeBooking->id) }}" class="btn btn-sm btn-outline-success mx-2 border-2" style="font-weight: 600 !important;">تعديل</a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('customer.bookHomeService.addServiceToExistingBooking') }}" enctype="multipart/form-data" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="home_service_booking_id" value="{{ $homeBooking->id }}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('ratings.store') }}" method="POST">
                                                        ...
                                                        <input type="hidden" name="service_id" value="{{ $homeBooking->home_service_id }}">
                                                        <input type="hidden" name="service_type" value="home">
                                                        <input type="hidden" name="seller_id" value="{{ $homeBooking->seller_id }}">
