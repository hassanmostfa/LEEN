                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="row my-4 font-weight-bold">
                                <span class="ml-4"><i class="fas fa-tag ml-2"></i>التصنيف: {{ $homeService->category->name }}</span>
                                <span class="ml-4"><i class="fas fa-bookmark ml-2"></i>الفئة الفرعية: {{ $homeService->subCategory->name }}</span>
                                <span class="ml-4"><i class="fas fa-user ml-2"></i>الجنس: {{ $homeService->gender == 'men' ? 'الرجال' : 'النساء' }}</span>
                                <span class="ml-4"><i class="fas fa-money-bill ml-2"></i>السعر: {{ $homeService->price }} ر.س</span>
                            ...
                            <div class="owner mb-4" style="font-size: 18px;line-height: 32px;">
                                ...
                                <div class="d-flex align-items-center justify-content-start gap-2 my-4">
                                    <img style="width: 70px;height: 70px;" class="rounded-circle img-fluid ml-2" src="{{asset($homeService->seller->seller_logo )}}" alt="User Image">
                                    <h5 class="ml-3 font-weight-bold my-0">الاسم : {{$homeService->seller->first_name}} {{$homeService->seller->last_name}}</h5>
                                    <span class="ml-3"><i class="fas fa-envelope ml-2" style="color: #89314f !important;"></i> البريد الالكتروني : {{$homeService->seller->email}}</span>
