...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('seller.homeServices.update', $homeService->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ $homeService->name }}" required>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">هذه الخدمة خاصة ب</label>
                            <select class="form-select" name="gender" required>
                                <option value="men" {{ $homeService->gender == 'men' ? 'selected' : '' }}>الرجال</option>
                                <option value="women" {{ $homeService->gender == 'women' ? 'selected' : '' }}>النساء</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="category_id" name="category_id" required>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ $homeService->category_id == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <select class="form-select" id="subcategory" name="sub_category_id" required>
                            ...
                            <option value="{{ $homeService->sub_category_id }}" selected>اختر التصنيف الفرعي</option>
                        </select>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="discount" name="discount" required>
                                <option selected  value="{{ $homeService->discount }}">{{ $homeService->discount == 1 ? 'نعم' : 'لا' }}</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="percentage" name="percentage" value="{{ $homeService->percentage }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control" id="points" name="points" value="{{ $homeService->points }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" value="{{ $homeService->price }}" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="booking_status" name="booking_status" required>
                                <option value="immediate" {{ $homeService->booking_status == 'immediate' ? 'selected' : '' }}>فوري</option>
                                <option value="previous_date" {{ $homeService->booking_status == 'previous_date' ? 'selected' : '' }}>بموعد مسبق</option>
                            </select>
                        </div>
                    </div>
                                    ...
                                    @foreach ($employees as $employee)
                                        <div class="form-check">
                                            <input 
                                                ...
                                                name="employees[]" 
                                                {{ in_array($employee->id, json_decode($homeService->employees, true)) ? 'checked' : '' }}>
