        ...
        <div class="card shadow">
            <div class="card-header py-2 bg-success text-white d-flex align-items-center justify-content-between gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h4 class="my-0 flex-grow-1" style="font-size: 20px; font-weight: 400;">كل الخدمات المنزلية</h4>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($homeServices as $service)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('seller.homeServices.show', $service->id) }}" class="btn btn-sm btn-outline-success mx-2 border-2" style="font-weight: 600 !important;">عرض</a>
                                        <a href="{{ route('seller.homeServices.edit', $service->id) }}" class="btn btn-sm btn-outline-primary mx-2 border-2" style="font-weight: 600 !important;">تعديل</a>
                                        <form action="{{ route('seller.homeServices.destroy', $service->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
