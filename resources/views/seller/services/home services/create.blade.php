        ...
        <div class="card shadow">
            <div class="card-header py-2 bg-success text-white">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <h4 class="my-0" style="font-size: 20px; font-weight: 400;">اضافة خدمة منزلية جديدة</h4>
                </div>
            </div>
            <div class="card-body">
                <form id="multiStepForm" action="{{ route('seller.homeServices.store') }}" method="POST" onsubmit="event.preventDefault(); submitForm();">
                    @csrf
                    <div class="steps-content">
                        ...
                        <div class="step step-1">
                            ...
                            <div class="mb-3">
                                <label for="name" style="font-weight: 600; font-size: 18px" class="form-label">اسم الخدمة <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="مثال: كي الشعر باحدث الادوات " required>
                            </div>

                            <div class="mb-3">
                                <label for="name" style="font-weight: 600; font-size: 18px" class="form-label">هذه الخدمة خاصة ب : <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                        ...
                        <div class="step step-2 d-none">
                            ...
                            <div class="row mb-3">
                                <!-- Show All Categories -->
                                <div class="col-md-6">
                                    <label for="category_id" style="font-weight: 600; font-size: 18px" class="form-label">التصنيف الاساسي <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label for="subcategory" style="font-weight: 600; font-size: 18px" class="form-label"> التصنيف الفرعي <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                            ...
                            <div class="col-md-12">
                                <label for="service_details" style="font-weight: 600; font-size: 18px" class="form-label">تفاصيل الخدمة <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                        ...
                        <div class="step step-3 d-none">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="price" style="font-weight: 600; font-size: 18px" class="form-label">السعر <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                                    <input type="number" class="form-control" id="price" name="price" placeholder="ادخل السعر" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="booking_status" style="font-weight: 600; font-size: 18px" class="form-label">نوع الحجز <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="discount" style="font-weight: 600; font-size: 18px" class="form-label">هل يوجد خصم ؟ <span title="هذا الحقل مطلوب" style="color: red;">*</span> </label>
                            ...
                            <div class="col-md-12 my-3">
                                <label for="employees" style="font-weight: 600; font-size: 18px" class="form-label">الموظفين(يمكنك اختيار اكثر من موظف) <span title="هذا الحقل مطلوب" style="color: red;">*</span></label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="button" class="btn" style="background-color: #2f3e3b; color: white;" onclick="window.location.href='{{ route('seller.homeServices.create') }}'">حسنا</button>
            </div>
        </div>
    </div>
</div>
...
function submitForm() {
    ...
    fetch('{{ route('seller.homeServices.store') }}', {  // Use the form action URL
        method: 'POST',
        body: formData,
    })
