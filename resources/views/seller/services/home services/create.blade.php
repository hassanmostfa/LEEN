...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form id="multiStepForm" action="{{ route('seller.homeServices.store') }}" method="POST">
                    @csrf
                    <div class="steps-content">
                        ...
                        <div class="step step-2 d-none">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="subcategory" style="font-weight: 600; font-size: 18px" class="form-label"> التصنيف الفرعي</label>
