                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th>الخدمة</th>
                                    <td>
                                        <li>{{ $studioBooking->studioService->name }}</li> <!-- Main Service Name -->
                                ...
                                <tr>
                                    <th>الموظف</th>
                                    <td>
                                        <li>{{ $studioBooking->employee->name }}</li> <!-- Main Employee Name -->
                                        @if($studioBooking->studioServiceBookingItems->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <li>{{ number_format($studioBooking->studioService->price, 2) }} SAR</li> <!-- Main Service Price -->
                                        @if($studioBooking->studioServiceBookingItems->isNotEmpty())
                                            <ul style="padding-right: 13px; margin: 0;">
                                                @foreach ($studioBooking->studioServiceBookingItems as $item)
                                                    <li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($studioBooking->booking_status == 'completed')
                            ...
                            <div class="d-flex justify-content-start mt-3 gap-2">
                                ...
                                <a href="{{ route('seller.studioBookings.newRequests') }}" class="btn btn-outline-secondary mt-3">عودة إلى قائمة الطلبات</a>
                        
                        <form action="{{ route('seller.studioBookings.accept', $studioBooking->id) }}" method="POST" class="mt-3">
                            @csrf
                            @method('PUT')
    ...
    <div class="modal-dialog" style="max-width: 800px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Rejection Form -->
                <form action="{{ route('seller.studioBookings.reject', $studioBooking->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
