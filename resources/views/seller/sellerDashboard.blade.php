												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="LeenAdmin" selected>لين 1</option>
															<option value="LeenDrupal" >لين 2</option>
															<option value="LeenWordpress" >لين 3</option>
														</select>
													</strong>
												</h2>

												<div id="salesSelectorItems" class="chart-data-selector-items mt-3">
													<!-- Flot: Sales LeenAdmin -->
													<div class="chart chart-sm" data-sales-rel="LeenAdmin" id="flotDashSales1" class="chart-active" style="height: 203px;"></div>
													<script>
													...
													<!-- Flot: Sales LeenDrupal -->
													<div class="chart chart-sm" data-sales-rel="LeenDrupal" id="flotDashSales2" class="chart-hidden"></div>
													<script>
													...
													<!-- Flot: Sales LeenWordpress -->
													<div class="chart chart-sm" data-sales-rel="LeenWordpress" id="flotDashSales3" class="chart-hidden"></div>
													<script>
										...
										<div class="col-xl-4 text-center">
											...
											<div class="liquid-meter-wrapper liquid-meter-sm mt-3">
												...
												<div class="liquid-meter-selector mt-4 pt-1" id="meterSalesSel">
													<a href="#" data-val="35" class="active m-0 p-0">هذا الشهر</a>
													<a href="#" data-val="28">هذه السنة</a>
												</div>
											</div>
										</div>
									</div>
						...
						<!-- <div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">It's easy to create custom graphs on LeenAdmin Template, there are several graph types that you can use.</p>
								</header>
								<div class="card-body"> -->
								...
								<div class="card-body">
									<table class="table table-responsive-md table-striped mb-0">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td>Leen- Responsive HTML5 Template</td>
											...
											<tr>
												<td>2</td>
												<td>Leen- Responsive Drupal 7 Theme</td>
												<td><span class="badge badge-success">Success</span></td>
												<td>
													<div class="progress progress-sm progress-half-rounded m-0 mt-1 light">
														<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
											...
											<tr>
												<td>5</td>
												<td>Leen- Responsive Admin HTML5 Template</td>
												<td><span class="badge badge-warning">Warning</span></td>
												<td>
													<div class="progress progress-sm progress-half-rounded m-0 mt-1 light">
